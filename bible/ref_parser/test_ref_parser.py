...
PARAMS = [
    ...
    {
        "ref": "Утр. – Мф., 90 зач., XXII, 15 – XXIII, 39. Лит. – Мф., 102 зач., XXIV, 36 – XXVI, 2.",
        "res": [
            RefBook(
                book="Мф",
                chapters=[
                    {"chapter__num": 22, "num__gte": 15},
                    {"chapter__num": 23, "num__lte": 39},
                ]
            ),
            RefBook(
                book="Мф",
                chapters=[
                    {"chapter__num": 24, "num__gte": 36},
                    {"chapter__num": 25},
                    {"chapter__num": 26, "num__lte": 2},
                ]
            ),
        ]
    },
    {
        "ref": "1_Ин., 72 зач., III, 10–20.",
        "res": [
            RefBook(
                book="1 Ин",
                chapters=[
                    {"chapter__num": 3, "num__gte": 10, "num__lte": 20},
                ])
            ],
    },
    {
        "ref": "Утр. – Ев. 1-е, Мф., 116 зач., XXVIII, 16–20. Лит. – 2 Тим., 296 зач., III, 10–15. Лк., 89 зач., XVIII, 10–14. Мчч.: Рим., 99 зач., VIII, 28–39. Лк., 105–106 зач., XXI, 8–19.",
        "res": [
            RefBook(
                book="Мф",
                chapters=[
                    {"chapter__num": 28, "num__gte": 16, "num__lte": 20},
            ]),
            RefBook(
                book="2 Тим",
                chapters=[
                    {"chapter__num": 3, "num__gte": 10, "num__lte": 15},
            ]),
            RefBook(
                book="Лк",
                chapters=[
                    {"chapter__num": 18, "num__gte": 10, "num__lte": 14},
            ]),
            RefBook(
                book="Рим",
                chapters=[
                    {"chapter__num": 8, "num__gte": 28, "num__lte": 39},
            ]),
            RefBook(
                book="Лк",
                chapters=[
                    {"chapter__num": 21, "num__gte": 8, "num__lte": 19},
            ]),
        ],
    },
    {
        "ref": "2 Пар 6, 36; 3 Цар. 8, 46; Еккл. 7, 20",
        "res": [
            RefBook(
                book="2 Пар",
                chapters=[
                    {"chapter__num": 6, "num": 36},
            ]),
            RefBook(
                book="3 Цар",
                chapters=[
                    {"chapter__num": 8, "num": 46},
            ]),
            RefBook(
                book="Еккл",
                chapters=[
                    {"chapter__num": 7, "num": 20},
            ]),
        ],
    },
]
...
def test_parser(testcase):
    line = testcase["ref"]
    rp = RefParser(line)
    assert len(rp.refs) == len(testcase["res"])
    for i, b in enumerate(testcase["res"]):
        assert b == rp.refs[i].book
